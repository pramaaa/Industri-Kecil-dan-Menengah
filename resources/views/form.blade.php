...
@if($edit==false)
@section('title','Menambahkan Data Industri Baru')
                    ...
                    <div class="card-body">
                        ...
                        <form name="formulir" action="/tambahkan" method="post" onsubmit="return validasiForm()">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="nama_pemilik" maxlength="50" value="{{ old('nama_pemilik') }}">
                            </div>
                            <div class="form-group">
                                <label for="alamat">Alamat</label>
                                <textarea class="form-control" id="alamat" name="alamat" rows="4" cols="60" maxlength="90">{{ old('alamat') }}</textarea>
                            </div>
                            <div class="form-group">
                                <label for="telp">Nomor Telepon</label>
                                <input class="form-control" type="text" name="telp" maxlength="15" value="{{ old('telp') }}">
                            </div>
                            <div class="form-group">
                                <label for="tenaga_kerja">Jumlah Tenaga Kerja</label>
                                <input class="form-control" type="number" name="tenaga_kerja" min="1" max="20" value="{{ old('tenaga_kerja') }}">
                            </div>
                            <div class="form-group">
                                <label for="kapasitas_produksi">Kapasitas Produksi</label>
                                <input class="form-control" type="number" name="kapasitas_produksi" min="1" max="10000000" value="{{ old('kapasitas_produksi') }}">
                            </div>
                            <div class="form-group">
                            <label for="nilai_investasi">Nilai Investasi (Tanpa titik)</label>
                                <input class="form-control" type="number" name="nilai_investasi" min="1" max="1000000000" value="{{ old('nilai_investasi') }}">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <input class="btn btn-primary mx-auto d-block" type="submit" value="Tambahkan">
                            </div>
                        </form>
                    </div>
                </div>
                ...
                <div class="card mt-5">
                    <div class="card-body">
                        ...
                        <form name="formulir" action="/industri/update/" method="post" onsubmit="return validasiForm()">
                            ...
                            <div class="form-group">
                                <label for="nilai_investasi">Nilai Investasi (Tanpa titik)</label>
                                <input class="form-control" type="number" name="nilai_investasi" min="1" max="1000000000" value="{{ $i->nilai_investasi }}">
                            </div>
                            <div class="form-group">
                                <label for="komoditi">Komoditi</label>
                                <select class="form-control select2" style="width: 100%;" name="komoditi_id" id="komoditi_id">
