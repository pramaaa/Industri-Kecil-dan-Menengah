...
<div class="card text-sm">
	<div class="card-body">
		...
		<a href="/industri/export_excel" class="btn btn-success my-3" target="_blank"><i class="fa fa-download"> Unduh Format Excel</i></a> &nbsp;
		<button type="button" class="btn btn-primary my-3" data-toggle="modal" data-target="#importExcel">
		<i class="fa fa-upload"> Import File Excel</i></button>&nbsp;&nbsp;
		<a href="#" class="btn btn-danger my-3 deleteall" target=""><i class="fa fa-trash"> Hapus Seluruh Data</i></a> 
		...
		<form action="carikan" method="GET">
			<input class="form-control" type="text" name="nama" placeholder="Cari Industri .." value="{{ old('cari') }}">
		</form>
		<br>
		...
		<table class="table table-bordered" border="1">
			...
			@foreach($industri as $i)
				<tr>
					...
					<td>
						<a class="btn btn-warning btn-sm" href="/industri/{{ $i->id_industri }}/edit"><i class="fa fa-edit"style="font-size:15px"></i></a>
						<a class="btn btn-danger btn-sm delete" data-id="{{ $i->id_industri }}" data-nama="{{ $i->nama_industri }}" href="#"><i class="fa fa-trash" style="font-size:15px"></i></a>
					</td>
				</tr>
			@endforeach
			</tbody>
